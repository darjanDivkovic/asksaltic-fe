...
const HomePage = () => {
  ...
  return (
    <div className="relative px-[5%] lg:px-[15%] w-full h-screen overflow-hidden">
      ...
      <div className='flex w-full justify-between py-10 lg:py-20 relative z-10 items-center'>
        <div ref={logoRef}>
      ...
      <div className='flex flex-col relative z-10 mt-[3%]'>
        ...
        <h1 className='text-[10vw] sm:text-[8rem] font-custom leading-none sm:leading-[8rem] font-bold drop-shadow-2xl filter-none'>
          ASK<br />
        ...
        <p className='text-[3vw] sm:text-[15px] font-extralight opacity-80 mt-8 w-full sm:w-[55%]'>
